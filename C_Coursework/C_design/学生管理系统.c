...
void display_options()
{
	...
	printf(L_GREEN   "***---------------------------*---------------------------***\n"NONE);
	printf(L_BLUE    "*  1、输入学生信息     2、删除学生信息     3、查询学生信息  *\n"NONE);	
	printf(L_PURPLE  "*  4、修改学生信息     5、排序学生信息     6、展示学生信息  *\n"NONE);
	printf(L_D_GREEN "*  7、读取学生信息     8、保存学生信息     9、显示操作选项  *\n"NONE);
    printf(L_RED     "*  0、退出管理系统                                          *\n"NONE);
	printf(L_GREEN   "***---------------------------*---------------------------***\n"NONE);
	printf(L_YELLOW  "*************************************************************\n"NONE);
}
...
void read_information(List L)
{
    ...
    {
        stream = fopen("/home/yuanye/my_code/my_code.c/C_Coursework/C_design/学生信息.txt","r");
        if( stream == NULL)
